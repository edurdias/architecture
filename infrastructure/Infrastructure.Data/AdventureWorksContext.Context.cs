...
namespace AdventureWorks.Infrastructure.Data
{
    ...
    public partial class AdventureWorksContext : DbContext
    {
        ...
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorksContext].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
